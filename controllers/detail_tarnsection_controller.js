...
exports.insert_detail_tarnsection = (req, res, next) => {
    sql.query(
...
exports.update_detail_tarnsection = (req, res, next) => {
    sql.query(
...
exports.delete_detail_tarnsection = (req, res, next) => {
    sql.query(
        `   DELETE 
...
exports.get_detail_tarnsection_by_id = (req, res, next) => {
    sql.query(
        `   SELECT *
            FROM ${config.picky}.account 
            WHERE ${config.picky}.account.accId = ?;
